...
class EducationCategoriesPage extends StatelessWidget {
  ...
  void _navigateToListing(BuildContext context, String title) {
    if (title == "Tuition") {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const TuitionPage()),
      );
    } else {
      Navigator.push(
        context,
            ...
            GridView.count(
              ...
              children: [
                _buildCategoryCard(
                  context,
                  title: "Tuition",
                  subtitle: "School subjects &\nprivate tutors",
                  iconData: Icons.menu_book_outlined,
                  onTap: () => _navigateToListing(context, "Tuition"),
                ),
                _buildCategoryCard(
                  context,
                  ...
                  onTap: () => _navigateToListing(context, "Coaching Centre"),
                ),
                _buildCategoryCard(
                  context,
                  ...
                  onTap: () =>
                      _navigateToListing(context, "Computer Institute"),
                ),
                _buildCategoryCard(
                  context,
                  ...
                  onTap: () => _navigateToListing(context, "Spoken English"),
                ),
              ],
            ),
