...
class VehicleMapView extends StatefulWidget {
  final List<AutoTaxiListing> listings;
  final double userLat;
  final double userLng;
  final void Function(String phone) onCallTap;
  final void Function(AutoTaxiListing item) onDetailsTap;
...
class _VehicleMapViewState extends State<VehicleMapView> with TickerProviderStateMixin {
  AutoTaxiListing? _selected;
  ...
  Widget _buildSelectedCard(AutoTaxiListing item) {
...
class _RadarPainter extends CustomPainter {
  ...
  final double userLat;
  final double userLng;
  final AutoTaxiListing? selected;
...
class _VehicleMapMarker extends StatelessWidget {
  final AutoTaxiListing item;
  final bool isSelected;

  const _VehicleMapMarker({required this.item, required this.isSelected});
